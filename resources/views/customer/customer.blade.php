                    ...
                    <div class="crm-actions">
                        <button class="action-btn reminders-btn">
                            <svg class="btn-icon" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    d="M18 8.5V11a1 1 0 0 1-2 0v-2.5a4 4 0 0 0-8 0v2.5a1 1 0 0 1-2 0V8.5a6 6 0 0 1 12 0zM12 2v1M5 19h14M10 19v1a2 2 0 0 0 4 0v-1">
                                </path>
                ...
                <div class="crm-controls">
                    <div class="crm-search-container">
                        <div class="crm-search-wrapper">
                            <svg class="crm-search-icon" width="20" height="20" viewBox="0 0 24 24"
                ...
                <div class="customer-table-container">
                    <table class="customer-table">
                        ...
                        <tbody>
                                ...
                                <tr class="customer-row" data-animation-delay="{{ $index * 0.1 }}"
                                    ...
                                    <td class="customer-cell">
                                        <div class="customer-name">
                                            {{ $customer->Institution_Name ?? ($customer->Contact_Person ?? 'N/A') }}
                                        </div>
                                    </td>
                                    <td class="customer-cell">
                                    ...
                                    <td class="customer-cell">
                                        <span
                                            class="type-badge">{{ str_replace(['PrivateClinic', 'OtherInstitution'], ['Private Clinic', 'Other'], $customer->Customer_Type ?? 'N/A') }}</span>
                                    </td>
                                    <td class="customer-cell">
                                    ...
                                    <td class="customer-cell">
                                        <div class="last-interaction">
                                            {{ $customer->Last_Interaction_Date ? $customer->Last_Interaction_Date->diffForHumans() : 'Never' }}
                                        </div>
                                    </td>
                                    <td class="customer-cell">
                                        <div class="customer-actions">
                                            ...
                                            <button class="icon-btn delete-btn" title="Delete Customer"
                                                data-customer-id="{{ $customer->Customer_ID }}"
                                                data-customer-name="{{ $customer->Institution_Name ?? 'this customer' }}">
                                                <svg width="18" height="18" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="customer-cell"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function applyFilters() {
            ...
            document.querySelectorAll('.customer-row').forEach(row => {
                ...
                const matchSearch = !searchTerm || name.includes(searchTerm) || email.includes(
                    searchTerm);
        ...
        document.querySelectorAll('.view-btn').forEach(btn => {
            ...
            `;
                ...
                modal.querySelector('.edit-from-view-btn').addEventListener('click', () => {
                    ...
                    setTimeout(() => openEditCustomerModal(row.dataset.customerId),
                        300);
                });
                ...
                modal.querySelector('.create-quote-btn').addEventListener('click', () => {
                    closeModal(modal);
                    setTimeout(() => openCreateQuoteModal(row.dataset.customerId, name),
                        300);
                });
            });
        });
        ...
        async function openEditCustomerModal(customerId) {
            ...
            try {
                ...
                // Defaults/Fallbacks
                const name = custData.Institution_Name || row.querySelector('.customer-name')?.textContent
                    .trim() || '';
                ...
                const status = custData.Status || row.querySelector('.status-badge')?.textContent.trim() ||
                    'Active';
                ...
                modal.querySelector('#updateCustomerBtn').addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            if (result.errors) {
                                errorsDiv.innerHTML = Object.values(result.errors).flat().join(
                                    '<br>');
                            } else {
        ...
        document.addEventListener('click', async function(e) {
            ...
            if (logsBtn) {
                ...
                const buildTimelineItems = (items) => {
                    ...
                    return items.map(log => {
                        const date = new Date(log.Interaction_Date).toLocaleDateString(
                            'en-US', {
                                month: 'short',
                                day: 'numeric',
                                year: 'numeric',
                        ...
                        const colorClass = typeColors[log.Interaction_Type] ||
                            typeColors['Other'];
            ...
            `;
                ...
                const modal = createModal(`Timeline: ${customerName}`, body,
                    `<button class="modal-btn secondary close-modal">Close</button>`);
                ...
                logModal.querySelector('#saveLogBtn').addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            errorsDiv.style.display = 'block';
                            if (result.errors) {
                                errorsDiv.innerHTML = Object.values(result.errors)
                                    .flat().join('<br>');
                            } else {
        ...
        `;
            ...
            function calculateTotals() {
                ...
                modal.querySelector('#quoteSubtotal').textContent = '₱' + subtotal.toLocaleString('en-PH', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                });
                modal.querySelector('#quoteTax').textContent = '₱' + tax.toLocaleString('en-PH', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                });
                modal.querySelector('#quoteTotal').textContent = '₱' + total.toLocaleString('en-PH', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                });
                ...
                try {
                    ...
                    if (json.success) {
                        ...
                        if (json.errors) {
                            ...
                            errorsDiv.innerHTML = Object.values(json.errors).flat().join(
                                '<br>');
                        } else {
